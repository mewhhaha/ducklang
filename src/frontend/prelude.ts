...
import prelude_base64_text from "./prelude_base64.duck" with { type: "text" };
...
import prelude_json_string_text from "./prelude_json_string.duck" with {
  type: "text",
};
...
import prelude_numeric_parse_text from "./prelude_numeric_parse.duck" with {
  type: "text",
};
...
export const ducklang_base64_prelude_text = prelude_base64_text;
...
export function bundled_source_text(uri: string): string | undefined {
  ...
  if (uri === "duck:prelude/base64") {
    return ducklang_base64_prelude_text;
  }
  ...
  if (uri === "duck:prelude/json/string") {
    return ducklang_json_string_prelude_text;
  }
  ...
  if (uri === "duck:prelude/numeric/parse") {
    return ducklang_numeric_parse_prelude_text;
  }
